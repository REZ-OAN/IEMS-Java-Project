 ...
 * @author ahmed
 */
public class updateerror extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(91, 192, 248));
        ...
        rSMaterialButtonRectangle2.setBackground(new java.awt.Color(255, 109, 40));
        rSMaterialButtonRectangle2.setText("OK");
        rSMaterialButtonRectangle2.setFont(new java.awt.Font("Malgun Gothic Semilight", 1, 24)); // NOI18N
        rSMaterialButtonRectangle2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                rSMaterialButtonRectangle2ActionPerformed(evt);
            }
        });
        jPanel1.add(rSMaterialButtonRectangle2, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 180, 160, 60));

        jLabel3.setBackground(new java.awt.Color(188, 226, 158));
        jLabel3.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 36)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(51, 51, 51));
        jLabel3.setText("Update Can't Be Executed");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(updateerror.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

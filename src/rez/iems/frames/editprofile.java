...
public void initialize() {
    ...
    private void initComponents() {
        ...
        jPanel1.add(profilepic, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 20, 320, 240));
        ...
        phonenotxt.setCaretColor(new Color(255,255,255));
        jPanel1.add(phonenotxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 360, 250, 35));
        ...
        nametxt.setCaretColor(new Color(255,255,255));
        nametxt.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                nametxtActionPerformed(evt);
            }
        });
        jPanel1.add(nametxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 310, 250, 35));
        ...
        jPanel1.add(emailtxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 360, 250, 35));
        ...
        addresstxt.setCaretColor(new Color(255,255,255));
        jPanel1.add(addresstxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 310, 250, 35));
        ...
        jPanel1.add(nidtxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 410, 250, 35));
        ...
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 310, -1, 30));

        jLabel5.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 14)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(252, 255, 231));
        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel5.setText("Phone No :");
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 370, -1, -1));
        ...
        cpasstxt.setCaretColor(new Color(255,255,255));
        cpasstxt.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 12)); // NOI18N
        cpasstxt.setMargin(new java.awt.Insets(0, 10, 0, 0));
        cpasstxt.setPhColor(new java.awt.Color(252, 255, 231));
        cpasstxt.setPlaceholder("New Password....");
        jPanel1.add(cpasstxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 460, 330, 40));
        ...
        passtxt.setCaretColor(new Color(255,255,255));
        passtxt.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 12)); // NOI18N
        passtxt.setMargin(new java.awt.Insets(0, 10, 0, 0));
        passtxt.setPhColor(new java.awt.Color(252, 255, 231));
        passtxt.setPlaceholder("Password.....");
        jPanel1.add(passtxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 460, 330, 40));
        ...
        jPanel1.add(uploadimgbtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 30, 140, 40));
    ...
    private void uptbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_uptbtnActionPerformed
        ...
        cus.setPass(vcpass);
          boolean bb = true;
        String query = "select * from client where email='"+vemail+"' and pass='"+vpass+"' ";
        Connection connect = getcon.getConnection();
         try {
             ...
             {
                 query = "UPDATE `iems`.`client` SET `name` = '"+vname+"', `email` = '"+vemail+"', `phoneno` = '"+vcontactno+"', `pass` = '"+vcpass+"', `address` = '"+vaddress+"', `profilepic` = ? WHERE (`cnid` = '"+vnid+"');";

 ...
 * @author ahmed
 */
public class passwordinvalid extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Maximum 40 Characters");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 160, -1, 20));

        jLabel4.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 36)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(51, 51, 51));
        jLabel4.setText("Password Error");
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/rez/iems/figures/icons8-error-50.png"))); // NOI18N
        jLabel6.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 20, 80, 70));
        ...
        jPanel1.add(rSMaterialButtonRectangle2, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 190, 140, 40));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(passwordinvalid.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new passwordinvalid().setVisible(true);
            }
        });
    }

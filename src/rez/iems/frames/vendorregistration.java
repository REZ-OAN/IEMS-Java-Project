...
public class vendorregistration extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        bintxt = new app.bolivia.swing.JCTextField();
        ccodetxt = new app.bolivia.swing.JCTextField();
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 40, -1, 60));

        jLabel4.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 12)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 251, 235));
        jLabel4.setText("And Empowering Entrepreneurs ");
        ...
        jLabel3.setText("Implement Your Dreams");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 100, -1, -1));

        bintxt.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 3, 0, new java.awt.Color(153, 153, 153)));
        bintxt.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        bintxt.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 12)); // NOI18N
        bintxt.setMargin(new java.awt.Insets(0, 10, 0, 0));
        bintxt.setPlaceholder("Business Identification Number (BIN)");
        jPanel1.add(bintxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 280, 330, 40));

        ccodetxt.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 3, 0, new java.awt.Color(153, 153, 153)));
        ccodetxt.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        ccodetxt.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 12)); // NOI18N
        ccodetxt.setMargin(new java.awt.Insets(0, 10, 0, 0));
        ccodetxt.setPlaceholder("Company Code..");
        jPanel1.add(ccodetxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 280, 330, 40));
        ...
        jPanel1.add(cpasstxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 430, 330, 40));
        ...
        jPanel1.add(passtxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 370, 330, 40));
        ...
        jPanel1.add(signinbtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 200, 140, 50));
        ...
        addresstxt.setPlaceholder("Location...\n");
        ...
        phonenotxt.setPlaceholder("Contact No..");
        ...
        nametxt.setPlaceholder("Company Name...");
        ...
        jPanel1.add(uploadimg, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 500, 170, 40));
        ...
        jPanel1.add(showpassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(870, 500, 150, 40));
        ...
        jPanel1.add(signupbtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 620, 140, 40));
        ...
        jPanel1.add(resetbtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 620, 140, 40));
        ...
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 350, -1, 20));
        ...
        jPanel1.add(imgpreview, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 370, 320, 240));
      ...
      vendorentities ven = new vendorentities();
    ...
    private void signupbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_signupbtnActionPerformed
        ...
        int code = Integer.parseInt(ccodetxt.getText());
        if(pass.equals(cpass)==false)
        {
            ...
            ven.setBin(bin);
            ven.setContactno(contactno);
            ven.setPass(pass);
            ven.setCode(code);
            if(ccodetxt.getText().equals("")!=true && name.equals("")!=true && email.equals("")!=true && ven.getImg().equals("")!=true && address.equals("")!=true && contactno.equals("")!=true && pass.equals("")!=true && cpass.equals("")!=true){
               vendorinfo venin = new vendorinfo(getcon.getConnection());
               vendorentities c = venin.getvendor(email, pass);
                if(c == null)
                {
                     boolean b = venin.savevendorinfo(ven);
                     if(b==true)
                     {
                          Thread th=new Thread(){
                @Override
    ...
    private app.bolivia.swing.JCTextField bintxt;
    private app.bolivia.swing.JCTextField ccodetxt;

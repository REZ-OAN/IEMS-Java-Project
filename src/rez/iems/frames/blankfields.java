 ...
 * @author ahmed
 */
public class blankfields extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Some FIelds Are Blank");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(blankfields.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

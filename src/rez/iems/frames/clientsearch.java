...
public class clientsearch extends javax.swing.JFrame {
   ...
   public static Connection connect = new getcon().getConnection();
    ...
    private void initComponents() {
        ...
        etd = new app.bolivia.swing.JCTextField();
        loc = new app.bolivia.swing.JCTextField();
        std = new app.bolivia.swing.JCTextField();
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Event ID", "Company Code", "Event Name", "Asking Amount"
            }
        ) {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 200, 780, 200));

        addbtn.setBackground(new java.awt.Color(255, 255, 153));
        addbtn.setForeground(new java.awt.Color(51, 51, 51));
        addbtn.setText("SEND REQUEST FOR SELECTED EVENTS");
        addbtn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                addbtnActionPerformed(evt);
            }
        });
        jPanel1.add(addbtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 550, 290, 40));

        etd.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        etd.setPlaceholder("Enter Ending Date in \"YYYY-MM-DD\" format");
        etd.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                etdActionPerformed(evt);
            }
        });
        jPanel1.add(etd, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 480, 270, 40));

        loc.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        loc.setPlaceholder("Enter Location to the Event");
        jPanel1.add(loc, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 420, 570, 40));

        std.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        std.setPlaceholder("Enter Start Date in \"YYYY-MM-DD\" format");
        std.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                stdActionPerformed(evt);
            }
        });
        jPanel1.add(std, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 480, 270, 40));
        ...
        jPanel1.add(view, new org.netbeans.lib.awtextra.AbsoluteConstraints(890, 420, 120, 40));
    ...
    private void addbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addbtnActionPerformed
        try {
            ...
            String eid = model.getValueAt(in, 0).toString();
            int ei = Integer.parseInt(eid);
            String ename = model.getValueAt(in, 2).toString();
            String payable = model.getValueAt(in,3).toString();
            connect = getcon.getConnection();
            float p = Float.parseFloat(payable);
            String cn = cus.getCnid();
            String sd = std.getText();
            String ed = etd.getText();
            String loca = loc.getText();
            String query = "insert into adds(eid,cnid,name,location,sdate,edate,pay,status) values(?,?,?,?,?,?,?,?)";
            PreparedStatement psmt=getcon.getConnection().prepareStatement(query);
            psmt.setInt(1,ei);
            psmt.setString(2,cn);
            psmt.setString(3,ename);
            psmt.setString(4,loca);
            psmt.setString(5,sd);
            psmt.setString(6, ed);
            psmt.setFloat(7,p);
    ...
    private void etdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_etdActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_etdActionPerformed
    ...
    private app.bolivia.swing.JCTextField etd;
    ...
    private app.bolivia.swing.JCTextField loc;
    ...
    private app.bolivia.swing.JCTextField std;

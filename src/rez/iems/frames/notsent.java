 ...
 * @author ahmed
 */
public class notsent extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Error Occurred While Requesting");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(notsent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
